...
class API(DefinedNamespace):
    ...
    Date: 2025-12-16 19:27:38.614618
    """
    ...
    AccessDelegation: URIRef  # Access to a Logistics Object delegated to an Organization
    ...
    hasChangeRequest: URIRef  # Recorded change requests in the Audit Trail of a Logistics Object
    ...
    hasLatestRevision: URIRef  # Latest revision of the Logistics Object. Starting with revision 0
    ...
    hasSupportedOntology: URIRef  # Supported ontologies on the server, MUST be non-versioned IRIs
    hasSupportedOntologyVersion: URIRef  # Supported ontology versions on the server, MUST be versioned IRIs
