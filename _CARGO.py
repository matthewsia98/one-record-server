...
class CARGO(DefinedNamespace):
    ...
    ALTERNATE_EMAIL_ADDRESS: URIRef  # Indicates a contact detail as alternate email address
    ALTERNATE_PHONE_NUMBER: URIRef  # Indicates a contact detail as alternate phone number
    ...
    Actor: URIRef  # Superclass: Actors are Persons or entities acting like a single person
    ...
    BookingOptionRequest: URIRef  # Request object, refers to the Quote request or Booking request 
    BookingOptionStatus: URIRef  # Restricted code list containing the statuses of a booking option
    ...
    BookingStatus: URIRef  # Restricted code list containing the possible statuses of a booking
    ...
    DgRadioactiveIsotope: URIRef  # Details of the radioactive isotope contained in the product
    ...
    ExecutionStatus: URIRef  # Restricted code list for the execution status of activities
    ...
    LineItemPackage: URIRef  # Grouping of pieces for rating information as per Waybill box 22I
    ...
    NonHumanActor: URIRef  # Non-human actors are actors which are not a person, such as robots
    ...
    UNPLANNED_STOP: URIRef  # Indicates the that the movement time describes an unplanned stop
    UnitComposition: URIRef  # Activity to describe composition and decomposition of LoadingUnits
    ...
    accountingNoteIdentifier: URIRef  # String holding accounting information (AWB box 10)
    accountingNoteText: URIRef  # String holding the identifier in an accounting note (AWB box 10)
    ...
    activityLevelMeasure: URIRef  # Numeric expression of the activity of a radioactive Item
    ...
    address: URIRef  # Address details
    addressCode: URIRef  # Address identifier using special coding systems e.g. US CBP FIRMS code
    ...
    associatedEpermit: URIRef  # Reference to the permits associated with the Live Animals
    associatedOrganization: URIRef  # Reference to the Organization the Actor is associated with
    ...
    attachedToObject: URIRef  # Reference to the PhysicalLogisticsObject the IotDevice is attached to
    ...
    bookingTimes: URIRef  # Information about the Booking Times of a provided Booking Option
    ...
    carrierDeclarationDate: URIRef  # Date upon which the certification is made by the carrier
    ...
    certifiedByActor: URIRef  # Reference to the Actor certifying the result of the Check if required
    ...
    chargeQuantity: URIRef  # Double describing the time or item basis quantity of a charge
    ...
    chargeableWeightForRate: URIRef  # Chargeable weight for which the rate description details apply
    ...
    composedMaterials: URIRef  # References to the Materials being built-up or broken-down
    composedPieces: URIRef  # References to the Pieces being built-up or broken-down
    compositionActions: URIRef  # References to all CompositionActions performed for the UnitComposition
    ...
    contactDetailType: URIRef  # Type of the contact details, e.g. Phone number, Mail address
    contactDetails: URIRef  # Information about contactDetails
    contactPersons: URIRef  # References to Actors (Person, NonHumanActor) acting as contacts
    ...
    contentOfDgProductRadioactive: URIRef  # Reference to the DgProductRadioactive this Isotope is contained in
    ...
    createdAtLocation: URIRef  # Location of the document, e.g. location where the document was emitted
    ...
    declarationPlace: URIRef  # Reference to the Location the DgDeclaration was declared at
    declaredValueForCarriage: URIRef  # The value of a shipment declared for carriage purposes
    declaredValueForCustoms: URIRef  # The value of a shipment declared for customs purposes
    ...
    describedObjects: URIRef  # Reference to the Items or Pieces in which the product can be found.
    ...
    documentLink: URIRef  # Link to the document, e.g. URL of the file where it is hosted
    ...
    earliestAcceptanceTime: URIRef  # Earliest acceptance date time (requested or proposed)
    ...
    forBookingOption: URIRef  # Reference to the BookingOption the LogisticsObject is detailing
    forBookingOptionRequest: URIRef  # Reference to the BookingOptionRequest the information of the LogisticsObject is detailing
    forBookingRequest: URIRef  # Reference to the Booking Request the of the Booking Option
    ...
    goodsDescriptionForRate: URIRef  # Goods description used in the rate described by the Line Item
    goodsTypeCode: URIRef  # Appendix number of the convention (I, II or III) (box 1)
    goodsTypeExtensionCode: URIRef  # Appendix number of the convention (I, II or III) (box 1)
    grandTotal: URIRef  # Total price
    grossWeight: URIRef  # Weight details
    grossWeightForRate: URIRef  # Gross weight for which the rate description details apply
    ...
    iataCargoAgentLocationIdentifier: URIRef  # IATA CASS cargo agent 4 digit branch number / location identifier
    ...
    itemQuantity: URIRef  # Quantity of the item when applicable, with associated units of measure
    ...
    loadingPositionIdentifier: URIRef  # Short text stating the loading position in the TransportMeans
    ...
    lowDispersibleIndicator: URIRef  # A notation that the material is low dispersible radioactive material.
    ...
    measurementValue: URIRef  # Information about all non-Geolocation values of the measurement
    ...
    note: URIRef  # Free text for customs remarks, not used in OCI Composition Rules Table
    ...
    onTransportMeans: URIRef  # Reference to the TransportMeans that is being onloaded or offloaded
    onsiteActions: URIRef  # References to the Actions happening at the Location
    operatedTransportMovement: URIRef  # Transport Movement on which the Transport Means is used
    ...
    operatingTransportMeans: URIRef  # Reference to the TransportMeans operating the TransportMovement
    ...
    otherCustomsInformation: URIRef  # Supplementary Customs, Security and Regulatory Control Information
    otherIdentifierType: URIRef  # Identifier type or description
    otherIdentifiers: URIRef  # Details about any other identifier, depending on the context of use
    ...
    packageGrossWeight: URIRef  # Information about the total weight of a grouping of pieces
    ...
    packagingDangerLevelCode: URIRef  # Packing group, If used must reference I, II or III
    packagingType: URIRef  # Packaging details 
    ...
    physicalChemicalForm: URIRef  # A description of the physical and chemical form of the material.
    pieceCountForRate: URIRef  # Number of pieces for which the rate description details apply
    ...
    priceSpecification: URIRef  # Specification of the price e.g. Street, Group, Spot, etc.
    ...
    quantityForUnitPrice: URIRef  # Product quantity for unit price - e.g. 12 (eggs for one USD 1)
    ...
    rateClassCode: URIRef  # Rate class code e.g. Q. Refer to CXML Code List 1.4 Rate Class Codes
    rateClassCodeBasic: URIRef  # Rate Surcharge/Reduction - Basic Rate Class Code
    rateGrossWeight: URIRef  # Information about the total gross weight considered for a rate
    ...
    reasonsForAdjustments: URIRef  # A free text for user to include a reason for correction
    receivedFrom: URIRef  # Regulated entity that tendered the consignment
    recordedGeolocation: URIRef  # Reference to the Geolocation recorded of the measurement
    ...
    regulatedEntityIdentifier: URIRef  # Regulated entity identifier as per IATA e-CSD/CSD Resolution 65
    ...
    sensorType: URIRef  # Type of sensor as described in Interactive Cargo Recommended Practice
    ...
    shippingInfo: URIRef  # The shipper or its Agent may enter the appropriate optional shipping
    ...
    skeletonIndicator: URIRef  # Indicator whether a logistics object is a skeleton object
    ...
    spaceAllocationCode: URIRef  # Current status of the space allocation of the booking segment
    ...
    specimenDescription: URIRef  # Description of specimens, including age and sex if LA (box 9)
    ...
    storingActions: URIRef  # References to all StoringActions performed for the Storing Activity
    ...
    subLocations: URIRef  # References to Sublocations that describe the Location in more detail
    ...
    textualHandlingInstructions: URIRef  # Strings to provide free text handling instructions such as SSR and OSI
    ...
    timeOfAvailability: URIRef  # Time of availability of the shipment as per CargoIQ definition
    ...
    totalTransitTime: URIRef  # Total transit time as per CargoIQ definition, expressed as a duration
    ...
    transactionPurposeCode: URIRef  # Code indicating the purpose of the transaction (box 5a)
    transportContractId: URIRef  # Reference to the Air Waybill or other transport contract document (box 15)
    transportContractTypeCode: URIRef  # Code specifying the transport document name (box 15)
    ...
    transportMeansServiceType: URIRef  # Type of transport means service, e.g. Aircraftor Truck
    ...
    uldLoadingIndicator: URIRef  # Indicator related to ULD loading (e.g. Main deck only)
    ...
    unitsPreference: URIRef  # Reference to unit preferences of the request (e.g. kg or cm)
    updateBookingOptionRequests: URIRef  # References to BookingOptionRequests that request to update the Booking
    ...
    vehicleRegistration: URIRef  # Vehicle identification - e.g. aircraft registration number
    ...
    volumetricWeight: URIRef  # Volumetric weight details
    volumetricWeightForRate: URIRef  # Volumetric weight used for the rate described by this line item
    waybill: URIRef  # Reference to the Waybill of the shipment
    waybillLineItems: URIRef  # Information about rates applying to this Waybill handled as line item
    waybillNumber: URIRef  # House or Master Waybill unique identifier
    waybillPrefix: URIRef  # Prefix used for the Waybill Number. Refer to IATA Airlines Codes
